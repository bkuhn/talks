...
+ Key lesson learned:
       + the free flow of staff &amp; relationship-building between the
         regulators &amp; those they regulate leads to initially subtle
         corruption in selective enforcement which often transforms into
         blatant favoritism &amp; regulatory misconduct.

# The Compliance Industrial Complex

+ As the primary person enforcing the GPL since 1999 &hellip;

+ I've been a major inspiration an industry of lawyers &amp; services &hellip;

+ whose primary goals are: &hellip;
